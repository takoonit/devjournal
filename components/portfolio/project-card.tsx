...
export function ProjectCard({ project, href }: ProjectCardProps) {
    return (
        <SpotlightCard className="group relative h-full p-6 flex flex-col border-zinc-800/80 hover:border-zinc-700/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-cyan-400/5">
            <Link
                href={href}
                aria-label={`Open ${project.name} build log`}
                className="absolute inset-0 z-10 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
            />

            <div className="flex items-start justify-between mb-4">
                <div className="relative z-10 antialias">
                    <h3 className="mb-1 text-xl font-semibold text-zinc-100 transition-colors group-hover:text-cyan-400">
                        {project.name}
                    </h3>
                ...
                {project.repositoryLink && (
                    <a
                        ...
                        className="relative z-30 -m-1 rounded p-1 text-zinc-400 transition-colors hover:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/70 hover:scale-110 active:scale-95 duration-200"
