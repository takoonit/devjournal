            ...
            <div className="mx-auto max-w-3xl">
                ...
                <form ref={formRef} onSubmit={onSubmit} className="space-y-6 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input id="title" value={title} onChange={(e) => setTitle(e.target.value)} onKeyDown={submitShortcut} autoFocus className="w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-3 text-zinc-100 focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400/50 transition-all" placeholder="What changed?" />
                    </div>

                    <div className="space-y-2 relative">
                        <label htmlFor="content" className="text-sm text-zinc-300">Body</label>
                        <textarea id="content" value={content} onChange={(e) => setContent(e.target.value)} onKeyDown={submitShortcut} className="h-52 w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-3 text-zinc-100 focus:outline-none focus:border-brand-400 focus:ring-1 focus:ring-brand-400/50 transition-all resize-none" placeholder="Write the story of what you built, fixed, or learned..." />
