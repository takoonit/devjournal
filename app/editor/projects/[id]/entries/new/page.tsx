            ...
            <div className="mx-auto max-w-3xl">
                ...
                <form onSubmit={onSubmit} className="space-y-6 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input id="title" value={title} onChange={(e) => setTitle(e.target.value)} className="w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-3 text-zinc-100" placeholder="What changed?" />
                    </div>

                    <div className="space-y-2">
                        <label htmlFor="content" className="text-sm text-zinc-300">Body</label>
                        <textarea id="content" value={content} onChange={(e) => setContent(e.target.value)} className="h-52 w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-3 text-zinc-100" placeholder="Write the story of what you built, fixed, or learned..." />
                    </div>
