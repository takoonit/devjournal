...
const config: Config = {
    ...
    theme: {
        extend: {
            ...
            fontFamily: {
                sans: ["var(--font-google-sans-flex)", "Arial", "sans-serif"],
                serif: ["var(--font-google-sans-flex)", "Arial", "sans-serif"],
                mono: ["var(--font-google-sans-flex)", "Arial", "sans-serif"],
            },
            fontSize: {
                display: ["clamp(3.25rem, calc(2rem + 5vw), 6rem)", { lineHeight: "0.95", letterSpacing: "-0.04em", fontWeight: "750" }],
                title: ["clamp(2rem, calc(1.5rem + 2vw), 3.5rem)", { lineHeight: "1", letterSpacing: "-0.025em", fontWeight: "700" }],
                subtitle: ["clamp(1.25rem, calc(1.1rem + 0.7vw), 1.75rem)", { lineHeight: "1.2", fontWeight: "650" }],
                ...
                ui: ["clamp(0.875rem, calc(0.825rem + 0.2vw), 1rem)", { lineHeight: "1.5", fontWeight: "500" }],
                meta: ["clamp(0.75rem, calc(0.72rem + 0.1vw), 0.875rem)", { lineHeight: "1.4", fontWeight: "500" }],
                label: ["clamp(0.75rem, calc(0.72rem + 0.1vw), 0.875rem)", { lineHeight: "1.25", letterSpacing: "0.02em", fontWeight: "650" }],
                folio: ["clamp(4rem, calc(2.75rem + 4vw), 7rem)", { lineHeight: "0.9", fontWeight: "800" }],
            },
            maxWidth: {
                measure: "66ch",
                page: "70rem",
            ...
            borderRadius: {
                DEFAULT: "var(--md-sys-shape-corner-full)",
